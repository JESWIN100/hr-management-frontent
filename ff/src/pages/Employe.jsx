...
<div>
  <label className="block text-sm font-medium text-slate-500 mb-1">Working Hours</label>
  <select
    {...register('working_hours')}
    className="w-full px-3 py-2 border border-gray-200 rounded-md focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 bg-white text-slate-600 appearance-none"
  >
    <option value="">Select Shift</option>
    <option value="9">09:00 AM - 06:00 PM</option>
    <option value="9">10:00 AM - 07:00 PM</option>
    <option value="9">08:00 AM - 05:00 PM</option>
    <option value="8">09:00 AM - 05:00 PM</option>
